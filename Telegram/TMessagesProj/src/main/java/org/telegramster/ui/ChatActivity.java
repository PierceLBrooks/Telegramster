...
import org.telegramster.messenger.AndroidUtilities;
import org.telegramster.PhoneFormat.PhoneFormat;
import org.telegramster.messenger.BuildConfig;
import org.telegramster.messenger.BuildVars;
import org.telegramster.messenger.ChatObject;
import org.telegramster.messenger.DataQuery;
import org.telegramster.messenger.DownloadController;
import org.telegramster.messenger.Emoji;
import org.telegramster.messenger.EmojiSuggestion;
import org.telegramster.messenger.LocaleController;
import org.telegramster.messenger.MediaController;
import org.telegramster.messenger.MessagesStorage;
import org.telegramster.messenger.NotificationsController;
import org.telegramster.messenger.SecretChatHelper;
import org.telegramster.messenger.SendMessagesHelper;
import org.telegramster.messenger.SharedConfig;
import org.telegramster.messenger.UserObject;
import org.telegramster.messenger.Utilities;
import org.telegramster.messenger.VideoEditedInfo;
import org.telegramster.messenger.browser.Browser;
import org.telegramster.messenger.support.SparseLongArray;
import org.telegramster.messenger.support.widget.GridLayoutManager;
import org.telegramster.messenger.support.widget.GridLayoutManagerFixed;
import org.telegramster.messenger.support.widget.LinearLayoutManager;
import org.telegramster.messenger.support.widget.LinearSmoothScrollerMiddle;
import org.telegramster.messenger.support.widget.RecyclerView;
import org.telegramster.messenger.ApplicationLoader;
import org.telegramster.messenger.FileLoader;
import org.telegramster.tgnet.ConnectionsManager;
import org.telegramster.tgnet.TLRPC;
import org.telegramster.messenger.ContactsController;
import org.telegramster.messenger.FileLog;
import org.telegramster.messenger.MessageObject;
import org.telegramster.messenger.MessagesController;
import org.telegramster.messenger.NotificationCenter;
import org.telegramster.messenger.R;
import org.telegramster.messenger.UserConfig;
import org.telegramster.ui.ActionBar.ActionBarLayout;
import org.telegramster.ui.ActionBar.AlertDialog;
import org.telegramster.ui.ActionBar.BackDrawable;
import org.telegramster.ui.ActionBar.BottomSheet;
import org.telegramster.ui.ActionBar.SimpleTextView;
import org.telegramster.ui.ActionBar.ThemeDescription;
import org.telegramster.ui.Adapters.MentionsAdapter;
import org.telegramster.ui.Adapters.StickersAdapter;
import org.telegramster.ui.Cells.BotSwitchCell;
import org.telegramster.ui.Cells.ChatActionCell;
import org.telegramster.ui.Cells.ChatLoadingCell;
import org.telegramster.ui.ActionBar.ActionBar;
import org.telegramster.ui.ActionBar.ActionBarMenu;
import org.telegramster.ui.ActionBar.ActionBarMenuItem;
import org.telegramster.ui.Cells.ChatMessageCell;
import org.telegramster.ui.Cells.ChatUnreadCell;
import org.telegramster.ui.Cells.CheckBoxCell;
import org.telegramster.ui.Cells.ContextLinkCell;
import org.telegramster.ui.Cells.MentionCell;
import org.telegramster.ui.Cells.StickerCell;
import org.telegramster.ui.Components.AlertsCreator;
import org.telegramster.ui.Components.AnimatedFileDrawable;
import org.telegramster.ui.Components.AnimationProperties;
import org.telegramster.ui.Components.BackupImageView;
import org.telegramster.ui.ActionBar.BaseFragment;
import org.telegramster.ui.Cells.BotHelpCell;
import org.telegramster.ui.Components.ChatActivityEnterView;
import org.telegramster.messenger.ImageReceiver;
import org.telegramster.ui.Components.ChatAttachAlert;
import org.telegramster.ui.Components.ChatAvatarContainer;
import org.telegramster.ui.Components.ChatBigEmptyView;
import org.telegramster.ui.Components.CombinedDrawable;
import org.telegramster.ui.Components.CorrectlyMeasuringTextView;
import org.telegramster.ui.Components.EmbedBottomSheet;
import org.telegramster.ui.Components.EmojiView;
import org.telegramster.ui.Components.ExtendedGridLayoutManager;
import org.telegramster.ui.Components.FragmentContextView;
import org.telegramster.ui.Components.InstantCameraView;
import org.telegramster.ui.Components.LayoutHelper;
import org.telegramster.ui.Components.NoSoundHintView;
import org.telegramster.ui.Components.NumberTextView;
import org.telegramster.ui.Components.PipRoundVideoView;
import org.telegramster.ui.Components.RadialProgressView;
import org.telegramster.ui.Components.RecyclerListView;
import org.telegramster.ui.Components.ShareAlert;
import org.telegramster.ui.Components.Size;
import org.telegramster.ui.Components.SizeNotifierFrameLayout;
import org.telegramster.ui.Components.StickersAlert;
import org.telegramster.ui.ActionBar.Theme;
import org.telegramster.ui.Components.TypefaceSpan;
import org.telegramster.ui.Components.URLSpanBotCommand;
import org.telegramster.ui.Components.URLSpanMono;
import org.telegramster.ui.Components.URLSpanNoUnderline;
import org.telegramster.ui.Components.URLSpanReplacement;
import org.telegramster.ui.Components.URLSpanUserMention;
import org.telegramster.ui.Components.UndoView;
import org.telegramster.ui.Components.voip.VoIPHelper;
                    ...
                    if ((index = animatingMessageObjects.indexOf(message)) != -1) {
                        ...
                        messageCell.getViewTreeObserver().addOnPreDrawListener(new ViewTreeObserver.OnPreDrawListener() {
                            ...
                            public boolean onPreDraw() {
                                ...
                                org.telegramster.ui.Components.Rect rect = instantCameraView.getCameraRect();
