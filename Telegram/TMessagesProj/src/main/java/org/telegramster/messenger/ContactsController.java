...
public class ContactsController {
    ...
    public void checkAppAccount() {
        ...
        try {
            Account[] accounts = am.getAccountsByType("org.telegramster.messenger");
            systemAccount = null;
        ...
        if (UserConfig.getInstance(currentAccount).isClientActivated()) {
            ...
            if (systemAccount == null) {
                try {
                    systemAccount = new Account("" + UserConfig.getInstance(currentAccount).getClientUserId(), "org.telegramster.messenger");
...
//        query.add(builder.build());
        ...
        builder.withValue(ContactsContract.Data.MIMETYPE, "vnd.android.cursor.item/vnd.org.telegramster.messenger.android.profile");
